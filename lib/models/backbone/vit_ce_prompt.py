...
from lib.utils.backbone_utils import combine_tokens, recover_tokens, token2feature, feature2token
from .vit import VisionTransformer
from lib.models.layer.attn_blocks import CEBlock, candidate_elimination_prompt
...
class VisionTransformerCE(VisionTransformer):
    ...
    def forward_features(self, z, x, mask_z=None, mask_x=None,
        ...
        z,_ = self.patch_embed(z)
        x,_ = self.patch_embed(x)

        z_dte,_ = self.patch_embed_prompt(z_dte)
        x_dte,_ = self.patch_embed_prompt(x_dte)
