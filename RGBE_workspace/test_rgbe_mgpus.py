...
from lib.test.tracker.LeeNet import LeeNetTrack
import lib.test.parameter.LeeNet as rgbe_prompt_params
...
def run_sequence(seq_name, seq_home, dataset_name, yaml_name, num_gpu=1, epoch=60, debug=0, script_name='prompt'):
    ...
    if script_name == 'LeeNet':
        params = rgbe_prompt_params.parameters(yaml_name, epoch)
        ostrack = LeeNetTrack(params)  # "VisEvent"
